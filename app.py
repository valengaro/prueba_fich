...
def main_app():
    ...
    if menu == "Resumen":
        ...
        pivot = pd.pivot_table(df, index=['Pais Real', 'Estado'], columns='Jornada en Suiza', values='Ciudad Prog', aggfunc='count')
        ...
        styled_df = sorted_df.style.apply(highlight_rows, axis=1).format="{:.0f}"
